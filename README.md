...
로또 6/45 번호 생성, 공식 당첨번호 비교, 결과 공유 및 이미지 저장을 제공하는 웹앱입니다. 생성한 번호는 Vercel 서버 API를 거쳐 Supabase에 저장할 수 있습니다.
...
정적 파일만 열어도 번호 생성·공식 결과 조회·공유 기능은 사용할 수 있지만, Supabase 저장은 Vercel API 환경에서 동작합니다.
